...
Why would we use these above options?  Basically if you're creating a log, you want your log to be useful. Having too much information makes it not useful anymore, however skipping errors gives just the minimal amount of information.
